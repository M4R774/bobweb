...
class ChatMember():
    chat = models.ForeignKey('Chat', related_name="wat dis?", null=False, on_delete=models.CASCADE)
    tg_user = models.ForeignKey('TelegramUser', related_name="dis wat?", null=True, on_delete=models.CASCADE)
